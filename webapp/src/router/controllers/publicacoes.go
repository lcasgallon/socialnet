...
//CurtirPublicacao  chama a API para curtir uma publicação no bnco de dados
...
//DescurtirPublicacao  chama a API para descurtir uma publicação no bnco de dados

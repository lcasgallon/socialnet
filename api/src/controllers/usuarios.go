...
//AtualizarUsuario altera informações de um usuário no banco
...
//PararDeSeguirUsuario permite que um usuário pare de siguir outro
...
//BuscarSeguidores busca os seguidores de um usuário salvo no banco
...
//BuscarSeguindo trás todos seguidores que um usuário está seguindo

...
func CriarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if erro = publicacao.Preparar("cadastro"); erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}
...
//BuscarPublicacoes busca todas publicações de um usuário e das pessoas que ele segue
...
//BuscarPublicacao busca uma publicação específica
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if erro = publicacao.Preparar("edicao"); erro != nil {
		respostas.Erro(w, http.StatusBadRequest, erro)
		return
	}
